...
export function ClubDeleteAction({
  clubId,
  clubName,
  compact = true,
}: {
  ...
  const recordName = clubName?.trim() ? `"${clubName.trim()}"` : "este club";
    ...
    <AlertDialog>
      ...
      <AlertDialogContent size="sm">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Estas a punto de desactivar <strong className="text-foreground">{recordName}</strong>. Esta accion ocultara
            el club en los listados activos.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
